...
const NAV = [
  ...
  { href: "/superadmin/musteriler", label: "Müşteriler", icon: "group", short: "Müşteri" },
  ...
  return (
    <div className="min-h-screen bg-surface-container-low lg:flex">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-surface-container-highest bg-surface-container-lowest/95 backdrop-blur lg:hidden">
        <div className="mx-auto grid max-w-lg grid-cols-6 gap-0.5 px-1 pb-[env(safe-area-inset-bottom)] pt-1">
          {NAV.map((item) => (
            <Link
              key={item.href}
              href={item.href}
